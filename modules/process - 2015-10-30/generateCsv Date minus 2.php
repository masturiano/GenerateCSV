...
switch($_POST['action']){
	...
	case 'generateStsRebTyp':
		...
		if($stsServerCon){
			...
			$serverCurrentDate = date("dmY", strtotime("$serverDate -2 day", time()));
			$serverCurrentDateMinOne = date("dmY", strtotime("$serverDate -2 day", time()));
	...
	case 'generateStsReaReb':
		...
		if($stsServerCon){
			...
			//6/24/1987
			$tranDate = date("m/d/Y", strtotime("$serverDate  -2 day", time()));
				...
				<form class="form-horizontal">
					...
					<div class="dvContainer">
						...
						<div class="divLogs">
							...
							//if (!mssql_connect('WIN-SYSTEM','otherincome','oi@pf_sts')) {
