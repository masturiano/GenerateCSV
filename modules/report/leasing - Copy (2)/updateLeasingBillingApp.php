...
include("updateLeasingBillingAppObj.php");

$updateLeasingBillingAppObj = new updateLeasingBillingAppObj();

switch($_POST['action']){
	
	case "oracleData":
		$updateLeasingBillingAppObj->oracleData();
	exit();
...
<html>
	<head>
		...
		function updateBankAcct(){
			...
			$.ajax({
				url: 'updateLeasingBillingApp.php',
				type: 'POST',
            ...
            <form class="form-horizontal">
                <div class="dvContainer">
                	<table border=0 align="center">
						<th colspan="2">
                        	<h4 align="center"><font style="font-family:Lucida Handwriting"> Update Leasing Billing Application </font></h4>
                        </th>
                        <tr>
