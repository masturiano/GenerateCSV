...
include("updateLeasingSetupObj.php");

$updateLeasingSetupObj = new updateLeasingSetupObj();

switch($_POST['action']){
	
	case "oracleData":
		$updateLeasingSetupObj->oracleData();
	exit();
            ...
            <form class="form-horizontal">
                <div class="dvContainer">
                	<table border=0 align="center">
						<th colspan="2">
                        	<h4 align="center"><font style="font-family:Lucida Handwriting"> Update Leasing Setup </font></h4>
                        </th>
                        <tr>
