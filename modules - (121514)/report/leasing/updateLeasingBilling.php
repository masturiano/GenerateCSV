...
include("updateLeasingBillingObj.php");

$updateLeasingBillingObj = new updateLeasingBillingObj();

switch($_POST['action']){
	
	case "oracleData":
		$updateLeasingBillingObj->oracleData();
	exit();
            ...
            <form class="form-horizontal">
                <div class="dvContainer">
                	<table border=0 align="center">
						<th colspan="2">
                        	<h4 align="center"><font style="font-family:Lucida Handwriting"> Update Leasing Billing </font></h4>
                        </th>
                        <tr>
